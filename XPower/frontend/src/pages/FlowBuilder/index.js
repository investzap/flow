...
import { colorTitleTable } from "../../styles/styles";
...
import {
  ...
  colorLineTableHover,
  colorPrimary,
  colorTitleTable as importedColorTitleTable,
  colorTopTable
} from "../../styles/styles";
...
const FlowBuilder = () => {
  ...
  return (
    <MainContainer style={{ backgroundColor: "#fff" }} className={classes.mainContainer}>
      <NewTicketModal
      ...
      <MainHeader>
        ...
        <MainHeaderButtonsWrapper>
          ...
          <Button
            ...
            style={{ textTransform: "none", backgroundColor: theme.palette.primary.main, color: "#fff" }}
          >
          ...
          <>
            {webhooks.map(contact => (
              ...
              >
                ...
                <Grid item xs={4} align="center" style={{ color: theme.palette.primary.contrastText }}  onClick={() => history.push(`/flowbuilder/${contact.id}`)}>
                ...
                <Grid item xs={4} align="end">
                  ...
                  >
                    <MoreVert
                      sx={{ color: theme.palette.primary.contrastText, width: "21px", height: "21px" }}
                    />
                  </Button>
                  {/* <IconButton
                    size="small"
                  ...
                  >
                    <EditIcon style={{ color: theme.palette.primary.contrastText }} />
                  </IconButton>
                  <IconButton
                    size="small"
                    onClick={e => {
                  ...
                  >
                    <ContentCopy style={{ color: theme.palette.primary.contrastText }} />
                  </IconButton>
                  <IconButton
                    size="small"
                  ...
                  >
                    <Stack sx={{ width: 24 }}>
                      <Build sx={{ width: 20, color: theme.palette.primary.contrastText }} />
                    </Stack>
                  </IconButton>
                  <Can
                    role={user.profile}
                    ...
                    yes={() => (
                      ...
                      >
                        <DeleteOutlineIcon style={{ color: theme.palette.primary.contrastText }} />
                      </IconButton>
                    )}
                  /> */}
                </Grid>
