...
const useStyles = makeStyles((theme) => ({
  ...
  imageSide: {
    flex: 1,
    background: `url('https://lojaonline.clickscertos.com.br/wp-content/uploads/2025/05/capazapflow.webp') no-repeat center center`,
  ...
  return (
    <>
      ...
      <div className={classes.root}>
        ...
        >
          <img
            src="https://lojaonline.clickscertos.com.br/wp-content/uploads/2025/05/iconzapzap.png"
            alt="WhatsApp"
