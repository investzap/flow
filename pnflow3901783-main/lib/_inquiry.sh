...
#  
#  print_banner
#  printf "${WHITE} 💻 Insira o link do GITHUB do XPower que deseja instalar:${GRAY_LIGHT}"
#  printf "\n\n"
#  read -p "> " link_git
#}
...
get_max_user() {
  ...
  print_banner
  printf "${WHITE} 💻 Informe a quantidade de Usuarios/Atendentes que a ${instancia_add} poderá cadastrar:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " max_user
}
...
inquiry_options() {
  ...
  print_banner
  printf "${WHITE} 💻 Bem vindo(a) ao Gerenciador XPower, selecione abaixo a proxima ação!${GRAY_LIGHT}"
  printf "\n\n"
  printf "   [0] Instalar XPower\n"
  printf "   [1] Atualizar XPower\n"
  printf "   [2] Deletar XPower\n"
  printf "   [3] Bloquear XPower\n"
  printf "   [4] Desbloquear XPower\n"
  printf "   [5] Alter. dominio XPower\n"
  printf "\n"
  read -p "> " option
